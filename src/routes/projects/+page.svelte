<script lang="ts">
  ...
  // Importar el nuevo componente ImageCarousel
  import ImageCarousel from '$lib/components/ImageCarousel.svelte'; // Ajusta la ruta si es necesario
          ...
          >
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-0">
              ...
              <div class="p-6 md:p-8 flex flex-col justify-center">
                ...
                <div
                  class="h-4 bg-gray-300 dark:bg-gray-600 rounded mb-2 w-3/4 animate-pulse"
                ></div>
                <div
                  class="h-4 bg-gray-300 dark:bg-gray-600 rounded mb-6 w-1/2 animate-pulse"
                ></div>
                <div class="flex flex-wrap gap-2 mb-6">
                  <div
                    class="h-6 w-16 bg-gray-300 dark:bg-gray-600 rounded-full animate-pulse"
                  ></div>
                  <div
                    class="h-6 w-20 bg-gray-300 dark:bg-gray-600 rounded-full animate-pulse"
                  ></div>
                </div>
                <div class="flex flex-col sm:flex-row gap-4">
                  <div
                    class="h-12 w-32 bg-gray-300 dark:bg-gray-600 rounded-lg animate-pulse"
                  ></div>
                  <div
                    class="h-12 w-32 bg-gray-300 dark:bg-gray-600 rounded-lg animate-pulse"
                  ></div>
