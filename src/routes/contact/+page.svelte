            ...
            <div data-animate-id="contact-info">
                {#if mounted && visibleElements.has('contact-info')}
                    <div transition:fly={{ y: 30, duration: 600, delay: 200, easing: quintOut }}>
                        <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl border border-gray-200 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
                            ...
                            <div class="space-y-6">
                                ...
                                >
                                    ...
                                    <div>
                                        <h3 class="font-semibold text-gray-900 dark:text-white">{m['contact.email']()}</h3>
                                ...
                                >
                                    ...
                                    <div>
                                        <h3 class="font-semibold text-gray-900 dark:text-white">{m['contact.locationTitle']()}</h3>
            ...
            <div data-animate-id="additional-info">
                {#if mounted && visibleElements.has('additional-info')}
                    <div transition:fly={{ y: 20, duration: 500, delay: 400, easing: quintOut }}>
                        <div class="bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl p-8 border border-blue-200 dark:border-blue-800 hover:shadow-lg transition-shadow duration-300">
